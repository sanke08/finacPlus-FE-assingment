...
const moduleMap = {'react':{get:()=>()=>__federation_import$1(new URL('__federation_shared_react-BrALZ0a1.js', import.meta.url).href),import:true},'react-dom':{get:()=>()=>__federation_import$1(new URL('__federation_shared_react-dom-B-igiCQ4.js', import.meta.url).href),import:true}};
...
'musicLibrary':{url:'https://sanke08.github.io/finacPlus-FE-assingment/music_lib/assets/remoteEntry.js',format:'esm',from:'vite'}
                ...
                const wrapShareModule = remoteFrom => {
                  return merge({
                    'react':{'19.1.1':{get:()=>get(new URL('__federation_shared_react-BrALZ0a1.js', import.meta.url).href), loaded:1}},'react-dom':{'19.1.1':{get:()=>get(new URL('__federation_shared_react-dom-B-igiCQ4.js', import.meta.url).href), loaded:1}}
